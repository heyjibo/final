...
public class IndentController {
    ...
    @PutMapping("/score/{ID}")
    public Indent updateScore(@PathVariable String ID, @RequestBody Map<String, Double> scoreMap) {
        Indent indent = indentService.getIndent(ID);
        indent.setScore(scoreMap.get("score"));
        indent.setDeliverScore(scoreMap.get("deliverScore"));
        return indentService.updateScore(indent);
    }

    @GetMapping("/searchByDate/{date}")
    public List<Indent> searchByDate(@PathVariable LocalDate date) {
